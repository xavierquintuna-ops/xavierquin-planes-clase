...
def build_prompt(asignatura: str, grado: str, edad: Any, tema_insercion: str, destrezas_list: List[Dict[str,str]]) -> str:
    instructions = (
        ...
        "Tu tarea es generar un plan de clase estructurado en formato JSON v芍lido, con actividades reales y recursos en l赤nea que sean gratuitos, actuales y funcionales al hacer clic.\n\n"
        "### Instrucciones:\n"
        ...
        "     * \"construccion\": **M赤nimo 5 actividades pedag車gicas** que desarrollen la destreza.\n"
        ...
        "       - Cada actividad debe incluir nombre, descripci車n y enlace v芍lido y gratuito.\n"
        "     * \"construccion_transversal\": Incluir **una actividad transversal** relacionada con el Tema de Inserci車n proporcionado por el usuario, con recurso en l赤nea si es posible.\n"
        "     * \"consolidacion\": Actividades de aplicaci車n y refuerzo de lo aprendido (ej. ejercicios de texto, organizadores gr芍ficos, mapas mentales, etc.).\n"
        ...
        "- Todos los enlaces deben ser actuales, gratuitos y accesibles p迆blicamente.\n"
